@echo off
setlocal
title Console-Style PC Wizard (Windows 11)
call :ColorNormal
...
:: Look for known Xbox Wireless Adapter VID/PID values:
::   VID_045E (Microsoft) with PID_02FE or PID_0B05
:: Use Win32_PnPEntity to scan devices.
for /f "tokens=* delims=" %%L in ('
    wmic path Win32_PnPEntity get DeviceID /format:list 2^>nul ^| findstr /I "VID_045E&PID_02FE VID_045E&PID_0B05"
') do (
    set "DongleFound=1"
)
